...
//TEST(gameLogicTest, orderReachesUpstreamTest) {
//        Game* game = new Game();

//        Player* consumer = new Player(CONSUMER, game, game->getStartingInventory());
//        Player* retailer = new Player(RETAILER, game, game->getStartingInventory());
//        Player* wholesaler = new Player(WHOLESALER, game, game->getStartingInventory());
//        Player* distributor = new Player(DISTRIBUTOR, game, game->getStartingInventory());
//        Player* factory = new Player(FACTORY, game, game->getStartingInventory());

//        game->addPlayer(consumer);
...
//        int testArgC = 1;
//        QApplication a(testArgC, testArgV);
//        BeerGameWindow w;
//        PlayerWindow* consumerW = new PlayerWindow(&w, *consumer);
//        PlayerWindow* retailerW = new PlayerWindow(&w, *retailer);
//        PlayerWindow* wholesalerW = new PlayerWindow(&w, *wholesaler);
//        PlayerWindow* distributorW = new PlayerWindow(&w, *distributor);
//        PlayerWindow* factoryW = new PlayerWindow(&w, *factory);
...
//        // manually place order for each player.

//        // Place an order of 6 in the first week. And check in third week if
//        // the upstream receives this order
//        retailer->processOrder(6);
//        wholesaler->processOrder(6);
//        distributor->processOrder(6);
//        factory->processOrder(6);

//        // orders for 2nd week
//        retailer->processOrder(7);
//        wholesaler->processOrder(7);
//        distributor->processOrder(7);
//        factory->processOrder(7);
